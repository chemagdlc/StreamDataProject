...
import org.apache.kafka.clients.producer.{KafkaProducer, ProducerRecord}//Open kafka producer
import scala.util.Random

import com.scalagenerator.model.ServerLog

//Create 100000 random server log events
object ServerLogGenerator {
  ...
  //Send them as a values to the topic server-logs, with the key being its eventId which is a UUID(universally unique identifier)
